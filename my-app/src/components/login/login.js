        ...
        <div className='h-screen px-2 py-2  bg-[url("../components/images/bg.jpg")] lg:flex md:flex  sm:flex-none  font-sans justify-center items-center min-h-screen relative grid-cols-2 '>
            <div className='Col1 text-sm text-white bg-blue-500 p-6 lg:rounded-l-2xl lg:h-3/4 xl:h-3/4 '>
                ...
                <div className='Banner mt-40  sm:items-center'>
                 ...
                 lg:w-[150px] h-[150px] lg:bg-blue-700/70 lg:rounded-xl lg:placeholder:shadow-decorationblock "></div>
                    ...
                    <div className=''>
                        <p className='text-sm font-poppins_regular '>Copyright © Designed & Developed by <a href="https://dexignzone.com/">Dexignzone</a>  2021</p>
                        <p className='text-sm font-poppins_regular mt-px sm:justify-center'><a className='facebook hover:text-blue-800' href="fb.com/nguyenkhacdanh.1010">Design by Danh 2022</a></p>
                    </div>
                </div>
            </div>
            <div className='formLogin  p-11 bg-white flex flex-col  lg:w-2/6 lg:rounded-r-2xl lg:h-3/4 xl:h-3/4'>
                ...
                <form onSubmit={handleFormSubmit}>
                    ...
                    <div className=''>
                        <button
                            className={'btnSignin w-full  bg-blue-600 hover:bg-blue-800  hover:-translate-y-1 hover:scale-110  p-2 rounded-xl text-white my-3 sm:text-center'}>
                            Sign in
                        </button>
                    </div>
