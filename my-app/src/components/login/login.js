...
const Login = () => {
    ...
    return (
        <div className='Screen min-h-screen font-sans  bg-[url("../components/images/bg.jpg")] lg:flex md:flex  sm:flex-none  lg:justify-center lg:items-center relative grid-cols-2 bg-cover bg-center  justify-center items-center '>
            <div className='Col1 text-sm overflow-hidden flex-col  text-white/80 bg-blue-500 p-6 lg:rounded-l-2xl h-3/4  md:rounded-l-xl md:text-lef lg:items-start sm:items-center  justify-center' >
            ...
            <div className='formLogin  p-11 bg-white flex flex-col h-3/4 lg:w-2/6  lg:h-3/4'>
